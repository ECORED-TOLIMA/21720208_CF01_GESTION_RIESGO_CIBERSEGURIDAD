  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido(data-aos="fade-right")
      .titulo-principal__numero
        span 2
      h1 Delitos informáticos y cibercrimen
    
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10.order-2.order-lg-1(data-aos="fade-left")
        p.mb-0 Los delitos informáticos y el cibercrimen, son acciones ilegales que se realizan usando computadoras, teléfonos, Internet u otros dispositivos tecnológicos. Estas actividades buscan dañar, robar información o sacar beneficios engañando a personas o afectando sistemas. Algunos ejemplos comunes son el robo de contraseñas, enviar virus a otros equipos, hacer compras con tarjetas robadas por Internet o engañar con correos falsos (#[i phishing]) para que la gente entregue sus datos personales. También existen ataques que pueden bloquear el funcionamiento de páginas #[i web] o sistemas completos, afectando a personas, empresas e incluso gobiernos. Estos delitos se han vuelto más frecuentes porque Internet se usa en casi todos los aspectos de la vida diaria de las personas, como estudiar, trabajar, comprar y comunicarse.
      .col-lg-2.col-4.mb-lg-0.mb-4.order-1.order-lg-2(data-aos="zoom-in")
        figure
    ...
    p.mb-5(data-aos="fade-right") A continuación, se detalla la evolución que ha tenido el cibercrimen, en los diferentes procesos tecnológicos que hacen parte de la ciberseguridad: 
    
    .tarjeta--BG043.p-4.px-md-5.mb-4(data-aos="fade-right")
      LineaTiempoC.color-acento-botones(text-small)
        .row.justify-content-center(titulo="Década de 1950-1970")
          ...
          .col-lg-6.col-10.mb-lg-0.mb-4.order-1.order-lg-2
            figure
    ...
    p.mb-5(data-aos="fade-right") Los delitos informáticos han evolucionado desde simples actos de #[i hacking] hasta operaciones criminales altamente organizadas que afectan a individuos, empresas y gobiernos en todo el mundo. Con el avance de la tecnología, las amenazas continúan diversificándose, lo que hace imprescindible la adopción de estrategias de ciberseguridad robustas y la colaboración internacional para mitigar estos riesgos. 
    ...
    .row.justify-content-center.mb-4
      .col-lg-10(data-aos="fade-left")
        p.mb-0 A continuación, se describen algunos de los principales actores del cibercrimen: 
    
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-4.col-6.mb-lg-0.mb-4(data-aos="zoom-in")
        figure
          img(src='@/assets/curso/temas/tema2/img10.png', alt='Imagen decorativa')
      .col-lg-6(data-aos="fade-left")
        LineaTiempoD.color-acento-botones
          div(numero="1" titulo="<em>Black hat hackers</em>").p-3
          ...
          div(numero="5" titulo="<em>Hacktivistas</em>").p-3
          ...
          div(numero="6" titulo="Actores patrocinados por Estados").p-3
    ...
    p.mb-5(data-aos="fade-right") Los delitos informáticos abarcan una amplia gama de actividades ilícitas que afectan a individuos, empresas y gobiernos. Algunos de los más comunes incluyen: 
    ...
    SlyderF.color-acento-botones.mb-5(columnas="col-lg-6 col-xl-4")
      .tarjeta.tarjeta--BG02.color-primario.p-4
        ...
        h5.text-center Cibercrimen financiero
        p.text-center.mb-0 Fraudes como el robo de tarjetas de crédito, #[i phishing], suplantación de identidad y estafas en línea, con el objetivo de obtener beneficios económicos de manera fraudulenta.
      .tarjeta.tarjeta--BG02.color-primario.p-4
        .row.justify-content-center.mb-4
          .col-lg-6.col-sm-4.col-6
            img(src='@/assets/curso/temas/tema2/img12.svg' alt='AvatarTop')
        h5.text-center #[i Malware]
      ...
      .tarjeta.tarjeta--BG02.color-primario.p-4
        ...
        p.text-center.mb-0 Uso indebido de datos personales para extorsión, suplantación de identidad o comercialización ilegal en la #[i web] oscura, lo que compromete la seguridad y derechos de las víctimas.
      .tarjeta.tarjeta--BG02.color-primario.p-4
        .row.justify-content-center.mb-4
          .col-lg-6.col-sm-4.col-6
            img(src='@/assets/curso/temas/tema2/img16.svg' alt='AvatarTop')
        h5.text-center Ataques DDoS (Denegación de Servicio Distribuido)
    ...
    p.mb-5(data-aos="fade-right") Los principales delitos contemplados en la ley incluyen: 
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-4.col-6.mb-lg-0.mb-4.order-1.order-lg-2(data-aos="zoom-in")
        figure
    ...
    .bloque-texto-g.color-primario.p-3.p-sm-4.p-md-5.mb-5
      .bloque-texto-g__img(
        :style="{'background-image':`url(${require('@/assets/curso/temas/tema2/img21.png')})`}" data-aos="fade-right"
      )
      .bloque-texto-g__texto.p-4(data-aos="fade-left")
        p.mb-0 En las últimas dos décadas, los delitos informáticos han crecido de manera exponencial, impulsados por la expansión del uso de tecnologías como los #[i smartphones], las computadoras portátiles, el Internet de las Cosas (IoT) y el comercio electrónico. Además, retomando lo mencionado previamente, la pandemia de COVID-19 aceleró la digitalización de las actividades cotidianas, lo que resultó en un aumento significativo de los ciberataques, especialmente los de #[i ransomware] y el fraude en línea. Los cibercriminales ahora operan en organizaciones criminales estructuradas, con objetivos financieros, políticos y, en algunos casos, militares.
    ...
    .tarjeta-BG02.px-md-5.px-4.mb-5
      .row.justify-content-center.align-items-center.mb-4
        .col-lg-5.order-2.order-lg-1(data-aos="fade-left")
          ...
          p.mb-0 La creciente popularidad de las criptomonedas también ha facilitado actividades ilegales, como el lavado de dinero y el uso de mercados oscuros en la #[i web]. Además, el cibercrimen se ha extendido al ámbito de la desinformación, donde los cibercriminales manipulan la opinión pública mediante #[i fake news] y #[i bots] en redes sociales, afectando elecciones, movilizaciones y creando caos social.
