  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero(data-aos="fade-right")
        span 3
      h1 Entorno de tecnologías de la información en las organizaciones
    ...
    .titulo.mb-5(data-aos="fade-left")
      ...
      h5.mb-0 El descubrimiento ¿Qué son las TIC?
    ...
    .titulo.mb-5(data-aos="fade-left")
      img(src='@/assets/curso/temas/icon.svg', alt='Imagen decorativa')
      h5.mb-0  Tendencias emergentes: el futuro ya llegó

    figure.mb-4(data-aos="fade-right")
      .video
        iframe(width="1312" height="738" src="https://www.youtube.com/embed/PA7WcdWRDwo" title="Tendencias emergentes: el futuro ya llegó" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen)
