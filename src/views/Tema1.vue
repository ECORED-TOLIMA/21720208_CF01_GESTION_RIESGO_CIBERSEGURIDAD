...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .tarjeta--BG053.px-md-5.py-lg-0.py-4.mb-5
      .row.justify-content-center.align-items-center.my-lg-5.my-4
        .col-lg-4.col-md-6.col-8.desktop(data-aos="fade-right")
          figure
          ...
          SlyderF.color-acento-botones(columnas="col-lg-6")
            .tarjeta.bgblanco.p-4
              .row.justify-content-center.mb-4
                .col-4
                  img(src='@/assets/curso/temas/tema1/img5.svg' alt='Image decorativa')
              h5.text-center #[i Firewalls] y antivirus 
              p.text-center.mb-0 Para detectar y bloquear amenazas.
            .tarjeta.bgblanco.p-4
              .row.justify-content-center.mb-4
                .col-4
                  img(src='@/assets/curso/temas/tema1/img6.svg' alt='Image decorativa')
              h5.text-center Encriptación de datos 
              p.text-center.mb-0 Para proteger la información sensible.
            .tarjeta.bgblanco.p-4
              .row.justify-content-center.mb-4
                .col-4
                  img(src='@/assets/curso/temas/tema1/img7.svg' alt='Image decorativa')
              h5.text-center Autenticación multifactor (MFA)
              p.text-center.mb-0 Para reforzar el acceso seguro.
            .tarjeta.bgblanco.p-4
              .row.justify-content-center.mb-4
                .col-4
                  img(src='@/assets/curso/temas/tema1/img8.svg' alt='Image decorativa')
              h5.text-center Monitoreo continuo de redes
              p.text-center.mb-0 Para identificar posibles vulnerabilidades.
            .tarjeta.bgblanco.p-4
              .row.justify-content-center.mb-4
                .col-4
                  img(src='@/assets/curso/temas/tema1/img9.svg' alt='Image decorativa')
              h5.text-center Capacitación en seguridad digital
              p.text-center.mb-0 Para reducir el riesgo de errores humanos.
    
    p.mb-5 Uno de los mayores desafíos en ciberseguridad es la falta de concienciación de los usuarios. Muchas brechas de seguridad ocurren debido a prácticas inseguras, como el uso de contraseñas débiles o la apertura de enlaces sospechosos. Por ello, es fundamental fomentar la educación en seguridad digital a nivel individual y organizacional.
    ...
    p.mb-5 A continuación, se explica cada una de estas características principales de la ciberseguridad:  
    ...
    p.mb-5 También existen otras características esenciales que complementan y refuerzan la seguridad digital. Estas incluyen: 
    
    .row.justify-content-center.mb-5
      .col-lg-10(data-aos="fade-left")
        LineaTiempoD.color-acento-botones
          div(numero="1" titulo="Autenticidad")
          ...
          div(numero="2" titulo="No repudio")
          ...
          div(numero="3" titulo="Escalabilidad")
          ...
          div(numero="4" titulo="Resiliencia")
          ...
          div(numero="5" titulo="Seguridad proactiva")
          ...
          div(numero="6" titulo="Cumplimiento normativo")
          ...
          div(numero="7" titulo="Transparencia")
    ...
    p.mb-5 A continuación, se presentan algunas de las más reconocidas:
    ...
    .row.justify-content-center.mb-4
      .col-lg-10(data-aos="fade-left")
        .cajon.color-primario.p-4
          p.mb-0 Estas normas no solo ofrecen un enfoque integral para la ciberseguridad, sino que también buscan armonizar las mejores prácticas a nivel mundial, permitiendo la protección de la información en entornos cada vez más globalizados y digitales.
